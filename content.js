...
function frameLoad() {
  ...
  if (document.getElementsByClassName('dlgContent')[0].getElementsByTagName('iframe')[0].contentWindow.document.head != null) {
    ...
    addFrameCss('.fLinkDiv {color: ' + textColor + ' !important; background-color: ' + $1dp +' !important; padding: 8px !important;}')
    ...
    addFrameCss('table.feed div.head {background-color: ' + primaryDark + ' !important; color: ' + textColor + ' !important;}')
    addFrameCss('.filter {color: ' + textColor + ' !important; border-top-color: ' + primaryDark + ' !important;}')
    addFrameCss('div.lp {background-color: ' + $1dp + ' !important; color: ' + textColor + ' !important; border: solid 0px #efeeee !important;}')
    ...
    addFrameCss('table.Report {color: ' + textColor + ' !important;}')
...
addCss('.Light {color: ' + textColor + ' !important;}')
